    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modaleditmenuLabel"><?= $title; ?></h5>
            ...
            <div class="modal-body">
                <?php echo form_open('updateMenu', ['class' => 'formsimpan']); ?>
                <?= csrf_field(); ?>
                <div class="form-group row nopadding" hidden>
                    <label class="col-4 col-sm-4 col-form-label" for="tm_id">ID</label>
                    <div class="col-8 col-sm-8">
                        <input type="text" name="tm_id" id="tm_id" class="form-control form-control-sm" value="<?= $tm_id; ?>">
                ...
                <div class="row">
                    <div class="container-fluid">
                        <div class="form-group row nopadding">
                            ...
                            <div class="col-8 col-sm-8">
                                <input type="text" name="tm_sort" id="tm_sort" class="form-control form-control-sm" value="<?= $tm_sort; ?>">
                        ...
                        <div class="form-group row nopadding">
                            ...
                            <div class="col-8 col-sm-8">
                                <input type="text" name="tm_nama" id="tm_nama" class="form-control form-control-sm" value="<?= $tm_nama; ?>">
                        ...
                        <div class="form-group row nopadding">
                            ...
                            <div class="col-8 col-sm-8">
                                <input type="text" name="tm_class" id="tm_class" class="form-control form-control-sm" value="<?= $tm_class; ?>">
                        ...
                        <div class="form-group row nopadding">
                            ...
                            <div class="col-8 col-sm-8">
                                <input type="text" name="tm_url" id="tm_url" class="form-control form-control-sm" value="<?= $tm_url; ?>">
                        ...
                        <div class="form-group row nopadding">
                            ...
                            <div class="col-8 col-sm-8">
                                <input type="text" name="tm_icon" id="tm_icon" class="form-control form-control-sm" value="<?= $tm_icon; ?>">
                        ...
                        <div class="form-group row nopadding">
                            ...
                            <div class="col-8 col-sm-8">
                                <input type="number" name="tm_parent_id" id="tm_parent_id" class="form-control form-control-sm" value="<?= $tm_parent_id; ?>">
                            ...
                            <div class="col-8 col-sm-8">
                                <select id="tm_grup_akses" name="tm_grup_akses" class="form-select form-select-sm">
                                    ...
                                    <?php foreach ($userRole as $role) { ?>
                                        <option <?= $tm_grup_akses == $role['id_role'] ? 'selected' : ''; ?> value="<?= $role['id_role']; ?>"><?= $role['nm_role']; ?></option>
                                    <?php } ?>
                                </select>
                        ...
                        <div class="form-group row nopadding">
                            ...
                            <div class="col-8 col-sm-8">
                                <select id="tm_status" name="tm_status" class="form-select form-select-sm">
                                    <option <?= $tm_status == 0 ? 'selected' : ''; ?> value="0">Nonaktif</option>
                                    <option <?= $tm_status == 1 ? 'selected' : ''; ?> value="1">Aktif</option>
                                </select>
                    ...
                    <div class="modal-footer mt-3 justify-content-between">
                        ...
                        <button type="submit" class="btn btn-sm btn-primary float-end btnSimpan"> Update</button>
                    </div>
                </div>
                <?= form_close(); ?>
            </div>
